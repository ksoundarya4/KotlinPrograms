...
import com.bridgelab.addressbook.Address
...
object UtilClass {
    ...
    /**
     * Function to read person information
     *
     * @return Person
     */
    ...
    /**
     * Function to return matching person with id
     *
     * @return Person
     */
    fun searchPersonById(id: Int): Person? {
        val addressBook = AddressBook()
        for (person in addressBook.persons) {
            if (person.id == id)
                return person
        }
        return null
